    ...
    <div className="container max-w-3xl py-12">
      ...
      <div className="prose dark:prose-invert">
        <section className="mb-8">
          ...
          <p>
            At Zest Store, we respect your privacy and are committed to protecting your personal
            data. This privacy policy will inform you how we handle your personal data when you
        ...
        <section className="mb-8">
          ...
          <p>
            We use cookies to distinguish you from other users of our website, which helps us to
            provide you with a good experience and also allows us to improve our site.
          </p>
        </section>
