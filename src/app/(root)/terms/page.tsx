    ...
    <div className="container max-w-3xl py-12">
      ...
      <div className="prose dark:prose-invert">
        <section className="mb-8">
          ...
          <p>
            Welcome to Zest Store. These terms and conditions outline the rules and regulations for
            the use of our website and services.
          </p>
          <p>
            By accessing this website, we assume you accept these terms and conditions. Do not
            continue to use Zest Store if you do not agree to all of the terms and conditions stated
            on this page.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            Unless otherwise stated, Zest Store and/or its licensors own the intellectual property
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold">4. Your Privacy</h2>
          <p>Please read our Privacy Policy.</p>
        </section>

        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold">5. Reservation of Rights</h2>
          <p>
