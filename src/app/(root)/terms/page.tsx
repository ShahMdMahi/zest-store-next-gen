    ...
    <div className="container max-w-3xl py-12">
      ...
      <div className="prose dark:prose-invert">
        <section className="mb-8">
          ...
          <p>
            Welcome to Zest Store. These terms and conditions outline the rules
            and regulations for the use of our website and services.
          </p>
          <p>
            By accessing this website, we assume you accept these terms and
            conditions. Do not continue to use Zest Store if you do not agree to
        ...
        <section className="mb-8">
          ...
          <p>
            Unless otherwise stated, Zest Store and/or its licensors own the
